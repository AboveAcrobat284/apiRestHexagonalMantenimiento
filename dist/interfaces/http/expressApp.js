...
const adminsController_1 = require("../../adapters/controllers/adminsController");
...
app.post('/api/admins', adminsController_1.createAdmin);
app.get('/api/admins/:id', adminsController_1.getAdminById);
app.get('/api/admins', adminsController_1.getAllAdmins);
app.put('/api/admins/:id', adminsController_1.updateAdmin);
app.delete('/api/admins/:id', adminsController_1.deleteAdminById);
exports.default = app;
